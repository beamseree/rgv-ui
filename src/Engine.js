...
export function Engine({ ...props }) {
    ...
    return (
        <group
            ...
            <Select >
                {/* <Select name="gear" enabled={hovered === "gear"  }> */}
                <Select name="gear" enabled={hovered === "gear"}>
                ...
                <Select name="shaft" enabled={hovered === "shaft"}>
                ...
                <Select name="cylinder" enabled={hovered === "cylinder"}>
                ...
                <Select name="piston1" enabled={hovered === "piston1"}>
                ...
                <Select name="piston2" enabled={hovered === "piston2"}>
                ...
                <Select name="piston3" enabled={hovered === "piston3"}>

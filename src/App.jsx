...
export default function App() {
    ...
    useEffect(() => {
        if (focus) {
            let foundSensor = hoverables.sensors.find(
                (sensor) => sensor.id === focus.slice(6, focus.length)
            );
                                ...
                                <div className="list">
                                    {hoverables.sensors.map((sensor) => (
                                        <div
                                            className="list-item"
                                            onClick={() => {
                                                setFocus(`Object${sensor.id}`);
                                            }}
                                            onPointerOver={() =>
                                                hover(`Object${sensor.id}`)
                                            }
              ...
              /> */}
                ...
                <div className="canvas">
                        ...
                        <Suspense fallback={null}>
                            ...
                            <Selection>
                                ...
                                <Rgv
                                    ...
                                    hideCover={hideCover}
                                    setClickedHoverable={setClickedHoverable}
                                />
                            </Selection>
                    ...
                    <div className="canvas-buttons">
                        <Tooltip
                            placement="top"
                            title={hideCover ? "Show Cover" : "Hide Cover"}>
                            <Button
                                shape="square"
                                type="default"
                                size="large"
